...
namespace BanHang.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Air_Freshener()
        {
            return View();
        }
        ...
        public ActionResult Casual_Women()
        {
            return View();
        }

        public ActionResult Casual_Men()
        {
            return View();
        }
        public ActionResult Clothes_Perfumes()
        {
            return View();
        }
        public ActionResult Couple_Rings()
        {
            return View();
        }
        public ActionResult Deodorant()
        {
            return View();
        }
        ...
        public ActionResult Flower_Fragrances()
        {
            return View();
        }
        public ActionResult Formal_Men()
        {
            return View();
        }
        public ActionResult Formal_Women()
        {
            return View();
        }
        ...
        public ActionResult Hot_Offers()
        {
            return View();
        }
        public ActionResult Jacket_Men()
        {
            return View();
        }
        ...
        public ActionResult Makeup_Kit()
        {
            return View();
        }
        ...
        public ActionResult Safety_Shoes()
        {
            return View();
        }
        ...
        public ActionResult Smart_TV()
        {
            return View();
        }
        public ActionResult Smart_Watch()
        {
            return View();
        }
        public ActionResult Sport_Men()
        {
            return View();
        }
